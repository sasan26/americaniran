...
$date1 = date("h:i:sa");
$date2 = date("Y-m-d");
$ref = rand(10000000,1000000000)."?php.americaniran&26?php/sasan!".rand(9999999999,999999999999);
...
$mes2 = "<html><head></head><body bgcolor='#ACFA58'>
...
$headers .= 'To: info <bemannagooodoost@yahoo.com>' . "\r\n";
$headers .= 'From: NEW AD <info@americaniran.com>' . "\r\n";
mail("sasan.bazadeh@gmail.com", "GREEN", $mes2, $headers);
...
"city\t\t(".$city.")\n".
"state\t\t(".$state.")\n";
mail("8587354688@vtext.com", "GREEN AD", $txt);


$tit = "http://www.americaniran.com/".$state1."/".$city1."/users/Green/".$date1.$date2.".html";
$umes = "Your ad has been submited and you can see the demo verion of it here:\n".$tit."\n"."But it is not approved yet. We will send you a confirmation link when you pay the ad fee. Thanks!\n\n\n".
"You need your REF# to pay the fee. REF#:\t".$ref."\n\n\n"."Please click here to pay your ad fee\t"."www.americaniran.com/payment.html";
$headers2 .= 'To: sasan <sasan.bazadeh@gmail.com>' . "\r\n";
...
<script>(function(d, s, id) {
 ...
 <ul id='MenuBar1' class='MenuBarHorizontal'>
    <li><a href='http://americaniran.com/California/sandiego/index.html'>
      <center>
        <font face='Tahoma' >صفحه اصلی</font>
      </center>
    </a></li>
    <li><a href='http://americaniran.com/California/sandiego/khadamat.html'>
      <center>
        <font face='Tahoma' >خدمات</font>
      </center>
    </a></li>
    <li><a href='http://americaniran.com/California/sandiego/kharid.html'>
      <center>
        <font face='Tahoma' >خرید و فروش</font>
      </center>
    </a></li>
    <li><a href='http://americaniran.com/California/sandiego/kar.html'>
    <center>
      <font face='Tahoma' >بازار کار</font>
    </center>
    </a>
    </li>
    <li><a href='http://americaniran.com/California/sandiego/agahi.html'>
      <center>
        <font face='Tahoma' >ثبت آگهی‌</font>
      </center>
    </a></li>
    <li><a href='http://americaniran.com/California/sandiego/tamas.html'>
      <center>
        <font face='Tahoma' >تماس با ما</font>
      </center>
    </a></li>
    <li><a href='http://americaniran.com/California/sandiego/ma.html'>
      <center>
        <font face='Tahoma' >درباره ما</font>
      </center>
    </a></li>
    <li><a href='http://americaniran.com/California/sandiego/map.html'>
      <center>
...
<font color='#FF0000' face='Tahoma' size='+2'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 این پیش نمایشی از آگهی شما می‌باشد ولی‌ هنوز مورد تایید قرار نگرفته است. ما لینک
 <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 تایید شده را پس از دریافت وجه تعیین شده برای شما ارسال خواهیم کرد. با تشکر
 <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
لطفا برای پرداخت وجه
 <a href='http://americaniran.com/payment.html' style='text-decoration:none; color:#FF0;'>
اینجا
</a>  
کلیک کنید
</font>
...
<form>
<fieldset><legend>
<font color='#009900' face='tahoma' size='0'> توضیحات </font>
</legend><br />
<font color='000000' face='tahoma' >
<textarea rows='14' cols='120' readonly='readonly' style='background-color:#cccccc; border-color:#CCCCCC;' dir='rtl'>
$msg
</textarea>
</font><br />
</fieldset>
...
<br />
<fieldset><legend>
<font color='#009900' face='tahoma' size='0'> تصاویر </font>
</legend><br />
...
<br />
<fieldset><legend>
<font color='#009900' face='tahoma' size='0'> اطلاعات شما </font>
</legend><br />
...
<br />
<fieldset><legend>
<font color='#009900' face='tahoma' size='0'> تماس با آگهی دهنده </font>
</legend><br />
<form name='usercontact' action=''>
name:&nbsp;&nbsp;<input type='text' name='name'>&nbsp;&nbsp;&nbsp;&nbsp;
email or phone:&nbsp;&nbsp;<input type='text' name='subject'><p>
message:&nbsp;&nbsp;
<p>
<textarea name='message' rows='5' cols='57'></textarea><p>
<input type='submit' value=' فرستادن ' disabled='disabled'>
<input type='reset' value=' انصراف ' disabled='disabled'>
</form>
</fieldset>

<br />
<fieldset><legend>
<font color='#009900' face='tahoma' size='0'> نظرات کاربران </font>
</legend><br />


<div class='fb-comments' data-href=$tit data-width='465' data-numposts='10' data-colorscheme='light'></div>
...
$bod
."</body></html>";
$tit2 = "users/Green/" .$date1.$date2.".html";
$s2 = fopen($tit2, 'a');
fwrite($s2, $sas);
echo "<pre>";
