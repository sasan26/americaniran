...
$mes2 = "<html><head></head><body bgcolor='#FFFF00'>
<table border='1'>
...
mail("sasan.bazadeh@gmail.com", "YELLOW", $mes2, $headers);
...
"city\t\t(".$city.")\n".
"state\t\t(".$state.")\n";
mail("8587354688@vtext.com", "YELLOW AD", $txt);


$tit = "http://www.americaniran.com/".$state1."/".$city1."/users/Yellow/".$date1.$date2.".html";
...
$bod
."</body></html>";
$tit2 = "users/Yellow/" .$date1.$date2.".html";
$s2 = fopen($tit2, 'a');
fwrite($s2, $sas);
echo "<pre>";
